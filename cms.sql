...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2017 at 01:01 PM
...
--
DELIMITER $$
CREATE TRIGGER `quantity` AFTER INSERT ON `orders` FOR EACH ROW BEGIN
...
(1, 'Admin', 'ui-zac.jpg', 'admin@admin.com', '$2y$10$Wm5jpx7s8ZwFltO/I6Tvie.Wh16FLGVIUF8oI6OTziF2gm.T9mQi.', '9Eku0rKm87ZPdTjPmBwwG3D2wJsuWYrLXcAiBy9QWYUaSWeS6o6bkB0pZpWC', 1, '2016-01-03 08:48:36', '2017-03-17 09:59:22');
...
ALTER TABLE `categories`
  ...
  ADD KEY `fk_categories_categories_idx` (`parent_id`);
...
ALTER TABLE `color_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_productcolour_colour_idx` (`color_id`),
  ADD KEY `fk_productcolour_products_idx` (`product_id`);
...
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_orders_customers_idx` (`user_id`);
...
ALTER TABLE `posts`
  ...
  ADD KEY `fk_posts_comments_idx` (`post_id`);
...
ALTER TABLE `products`
  ...
  ADD KEY `fk_products_brand_idx` (`brand_id`),
  ADD KEY `fk_products_categories_idx` (`cat_id`);
...
ALTER TABLE `product_size`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_productsize_size_idx` (`size_id`),
  ADD KEY `fk_productsize_products1_idx` (`product_id`);
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `fk_products_brand` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`brand_id`) ON DELETE CASCADE ON UPDATE CASCADE,
